...
data_dir = Path("/data/spleen_raw/")
dataset = "HBM337.FSXL.564-f0c58e670ceb445e6ab02c6a20c83aee"
output_dir = Path.home() / f"dryad_dcl_outputs/spleen/{dataset}"
output_dir.mkdir(exist_ok=True, parents=True)

# Multiplex img in memmap mode
im = tff.memmap(data_dir / f"{dataset}/drv_CX_19-003_spleen_CC3-E_NEW/processed_2020-02-20/stitched/reg001/src_CX_19-003_spleen_CC3-E_reg001.tif")
im = im.reshape((im.shape[0] * im.shape[1], im.shape[2], im.shape[3]))

# Channel names capitalized
with open(data_dir / dataset / "drv_CX_19-003_spleen_CC3-E_NEW/channelNames.txt") as fh:
