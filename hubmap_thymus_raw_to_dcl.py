...
data_dir = Path("/data/thymus_raw/")
dataset = "HBM277.GJFC.833-65f12a80f54438ea3bf5c7200ecd70a3"
output_dir = Path.home() / f"dryad_dcl_outputs/thymus/{dataset}"
...
# Original tiling scheme: 13x9 grid - 117 tiles total
xstep = X.shape[2] // 9
ystep = X.shape[3] // 13
