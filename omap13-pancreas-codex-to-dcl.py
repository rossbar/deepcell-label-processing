...
data_dir = Path("/data2/omap-reference-datasets/omap-pancreas-13")
dataset = "DON126-B3A.qptiff"
output_dir = Path.home() / f"dryad_dcl_outputs/omap13-pancreas/"
output_dir.mkdir(exist_ok=True, parents=True)

# Multiplex img
img = tff.imread(data_dir / dataset)

# Channel names capitalized
df = pd.read_excel(data_dir / dataset.replace(".qptiff", "_metadata.xlsx"))
