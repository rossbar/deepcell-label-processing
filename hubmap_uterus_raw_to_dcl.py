...
output_dir = Path.home() / "dryad_dcl_outputs/uterus_raw"
print(output_dir)
output_dir.mkdir(exist_ok=True, parents=True)

for datapath in tqdm(data_dir.iterdir()):
    dataset = datapath.name
    ...
    dcl_zip(
        X, y, cell_types, channels, fname=output_dir / f"{dataset}.zip"
    )
