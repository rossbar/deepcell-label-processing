...
# Load image and mask
datapath = Path.home() / "data-registry/data/labels/static/2d/Tissue-Nervous/McCaffrey_TB_MIBI/Patient9-2.npz"
fname = datapath.name
...
segmentation_input = np.stack(
    [
        img[..., channels.index("Histone H3")],
        img[..., channels.index("CD45")]
    ],
    axis=-1
)
